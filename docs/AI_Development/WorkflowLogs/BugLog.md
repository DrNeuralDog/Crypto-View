...
[2026-03-02 23:46:10] App close could hang offline because marketfeed.Stop waited for in-flight provider/fx HTTP timeouts before returning - Fixed by adding feed run-context cancellation on Stop and early stop checks in market/fx cycles; verified with new TestFeedStopCancelsInFlightRequests.
[2026-04-10 22:28:00 +03:00] NotebookLM query prerequisite could not be executed because the 'nlm' CLI is not installed in the environment - Local project context was used; remote second-brain access remains blocked until nlm is installed/authenticated.
[2026-04-10 22:28:00 +03:00] Canonical quality-check script failed under Set-StrictMode because filtered gofmt output collapsed to a scalar without Count - Fixed by normalizing filtered results to an explicit array.
[2026-04-14 17:18:57 +03:00] README audit prerequisites: NotebookLM query could not run because nlm CLI is not installed; first go test ./... attempt was blocked by sandboxed Go build cache access to AppData - Continued with local code inspection and reran go test ./... with approval successfully.
